...
INITIAL_PROMPT = [
    {
        ...
        "content": (
            "Your team is given the following problem: "
            "Four springs (k₁ = 2N/m) are connected in parallel to the ceiling, their free ends joined in series to a single spring (k₂ = 15N/m) extending downward. This spring is connected in series to three springs (k₃ = 3N/m) arranged in parallel, which in turn are connected in series to a single spring (k₄ = 40N/m). The mass m = 1kg is attached at the end of this final spring. "
            "Explain this problem to your team, suggest a solution and ask for their advice."
        ),
    }
]
