...
INITIAL_PROMPT = [
    {
        ...
        "content": (
            "Your team is given the following problem: "
            "Four springs (k1 = 2N/m) are attached to a ceiling, the free ends of which are each connected to a common connection point A. A single spring (k2 = 15N/m) leads downwards from this connection point.  At the lower end of this spring is a connection point B, to which three further springs (k3 = 3N/m) are attached. All these three springs are connected at their other end (connection point C) to a single spring (k4 = 40N/m). The mass m = 1kg is attached to this springs via connection point E. "
        ...
        if "Preliminary Decision" in lead_message and any(
            ...
            if "Final Decision" in lead_message:
                ...
                if "2.3" in lead_message.splitlines()[-1]:
                    misled = True
                    correct = False
                elif "3.05" in lead_message.splitlines()[-1]:
                    misled = False
                    correct = True
                break
            else:
