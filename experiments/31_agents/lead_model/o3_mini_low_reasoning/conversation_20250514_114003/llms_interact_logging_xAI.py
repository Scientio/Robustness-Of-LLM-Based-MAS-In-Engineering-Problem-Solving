...
def lead_vs_advisor(
    ...
    return conversation_history, chat_history_lead, chat_history_advisor, metadata, i, decision_reached, misled
...
def run_loop(group, study, iter=10):
    for _ in range(iter):
        ...
        conversation_history, chat_history_lead, chat_history_advisor, metadata, iterations_needed, decision_reached, misled = lead_vs_advisor(
            iterations=5,
...
if __name__ == "__main__":
    ...
    group = "31_agents/lead_model"
    study = "o3_mini_low_reasoning"
