    ...
    experiments = [
        Experiment(
            ...
            advisor_configs = [
                ...
                {"name": "Pipe Engineer", "mode": "supportive", "expertise": "pipe engineering"},
            ]
        ),
        Experiment(
            group="33_system_design/number_of_advisors",
            study="FDs_APm_PEm",
            advisor_configs = [
                {"name": "Fluid Dynamics Expert", "mode": "supportive", "expertise": "fluid dynamics"},
                {"name": "Applied Physicist", "mode": "misleading", "expertise": "applied physics"},
