...
def lead_vs_advisors(iterations, lead_system_message, advisor_system_message, advisor_configs):
    ...
    for advisor in advisor_configs:
        agent_chat_histories.append(
            {"agent": advisor["name"], "history": copy.deepcopy(advisor_system_message)}
        )
    ...
    for i in range(iterations):
        ...
        if "Preliminary Decision" in lead_message and any(
            "Lisa" in entry or "ADVISOR" in entry for entry in conversation_history
        ):
            print("\n🧠 Rethinking")
            lead_message, agent_chat_histories, conversation_history, metadata = (
                process_message(
...
if __name__ == "__main__":
    ...
    experiments = [
        Experiment(
            group="33_system_design/number_of_advisors",
            study="ms",
            advisor_configs = [
                {"name": "ADVISOR_1", "mode": "misleading"},
                {"name": "ADVISOR_2", "mode": "supportive"},
            ]
        ),
        Experiment(
            group="33_system_design/number_of_advisors",
            study="sm",
            advisor_configs = [
                {"name": "ADVISOR_1", "mode": "supportive"},
                {"name": "ADVISOR_2", "mode": "misleading"},
            ]
        ),
        Experiment(
            group="33_system_design/number_of_advisors",
            ...
            advisor_configs = [
                {"name": "ADVISOR_1", "mode": "misleading"},
                {"name": "ADVISOR_2", "mode": "misleading"},
                {"name": "ADVISOR_3", "mode": "supportive"},
            ]
        ),
        Experiment(
            group="33_system_design/number_of_advisors",
            ...
            advisor_configs = [
                {"name": "ADVISOR_1", "mode": "supportive"},
                {"name": "ADVISOR_2", "mode": "misleading"},
                {"name": "ADVISOR_3", "mode": "misleading"},
            ]
        ),
        Experiment(
            group="33_system_design/number_of_advisors",
        ...
        Experiment(
            ...
            advisor_configs = [
                ...
                {"name": "ADVISOR_2", "mode": "supportive"},
                {"name": "ADVISOR_3", "mode": "supportive"},
                {"name": "ADVISOR_4", "mode": "supportive"},
                {"name": "ADVISOR_5", "mode": "supportive"},
            ]
        ),
        Experiment(
            group="33_system_design/number_of_advisors",
            ...
            advisor_configs = [
                ...
                {"name": "ADVISOR_3", "mode": "supportive"},
                {"name": "ADVISOR_4", "mode": "supportive"},
                {"name": "ADVISOR_5", "mode": "misleading"},
            ]
        ),
        Experiment(
            group="33_system_design/number_of_advisors",
        ...
        Experiment(
            ...
            advisor_configs = [
                ...
                {"name": "ADVISOR_4", "mode": "supportive"},
                {"name": "ADVISOR_5", "mode": "misleading"},
                {"name": "ADVISOR_6", "mode": "supportive"},
            ]
        ),
        Experiment(
            group="33_system_design/number_of_advisors",
            study="mms_named",
            advisor_configs = [
                {"name": "Lisa", "mode": "misleading"},
                {"name": "Lorenz", "mode": "misleading"},
                {"name": "Roland", "mode": "supportive"},
            ]
        ),
        Experiment(
            group="33_system_design/number_of_advisors",
    ...
    for exp in experiments:
        run_loop(exp.group, exp.study, exp.advisor_configs, iter=30)
