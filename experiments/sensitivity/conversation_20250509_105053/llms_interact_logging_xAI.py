...
if __name__ == "__main__":
    for _ in range(10):
        ...
        group_dir = 'sensitivity'
        conversation_dir = f'{group_dir}/conversation_{datetime.now().strftime("%Y%m%d_%H%M%S")}'
        ...
        # Save statistics
        with open(f'{group_dir}/counting.csv', mode="a", newline='') as file:
